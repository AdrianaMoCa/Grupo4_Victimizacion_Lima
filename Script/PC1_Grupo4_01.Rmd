...
### Además, al realizar el análisis por sexo, se identifica una mayor percepción de victimización por parte de las mujeres en todas las zonas de Lima Metropolitana, excepto Lima Centro. Destaca nuevamente el caso de Lima Moderna con una diferencia de cerca al 10%. 
...
# Construyendo un indicador de percepción de inseguridad en Lima Metropolitana por distrito
...
## Tabla de distritos con mayor sensación de inseguridad por delitos patrimoniales
